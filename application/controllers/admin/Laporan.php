...
class Laporan extends CI_Controller{
	...
	function lap_penjualan_perminggu(){
		...
		$x['jml']=$this->m_laporan->get_total_jual_perminggu($minggu);
		$x['data']=$this->m_laporan->get_jual_perminggu($minggu);
		$this->load->view('admin/laporan/v_lap_jual_perminggu',$x);
	}
