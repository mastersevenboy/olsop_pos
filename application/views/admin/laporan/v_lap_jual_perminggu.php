...
<table border="0" align="center" style="width:700px;border:none;"">
    <thead>
        <tr>
            <th><img src="<?php echo base_url() ?>assets2/images/logo.png" alt="" style="width:100px; height:100px;"></th>
         </tr>
    </thead>
    <tbody>
        <tr>
            <td align="center">Alamat : Jl.Klapasawit Kec. Kalimanah, Kab. Purbalingga, Jawa Tengah</td>
        </tr>
        <tr>
            <td align="center">No.Tlp : 0856-4767-6591</td>
        </tr>
    </tbody>
</table>
<br>
...
<thead>
<tr>
<th colspan="11" style="text-align:left;">Minggu : <?php echo $b['minggu'];?></th>
</tr>
    <tr>
