					...
					<table>
						...
						<tr>
		                    ...
		                    <td><input type="text" name="satuan" value="<?php echo $b['barang_satuan'];?>" style="width:130px;margin-right:5px;" class="form-control input-sm" readonly></td>
		                    ...
		                    <td><input type="text" name="jumlah" id="jumlah" class="form-control input-sm" style="width:130px;margin-right:5px;" required></td>
